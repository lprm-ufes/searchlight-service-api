...
},{"./ajax":1,"./events":7,"/home/wancharle/searchlight-service-api/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":13,"blueimp-md5":undefined,"node-localstorage":undefined}],12:[function(require,module,exports){
(function (process){
// Generated by CoffeeScript 1.9.2
(function() {
...
},{"./ajax":14,"./events":20,"/home/wancharle/searchlight-service-api/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":13,"blueimp-md5":undefined,"node-localstorage":undefined}],25:[function(require,module,exports){
(function (process){
var CLIENT_SIDE, Dicionario, dms2decPTBR, getURLParameter, md5, parseFloatPTBR, string2function,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
...
(function (process){
var SLSAPI, api, apid, teste, testeCSV, testeGoogle, testelogin, testelogin2, testemain;
...
testelogin2 = function() {
  api.user.login('wan', '123456');
  api.on(SLSAPI.User.EVENT_LOGIN_SUCCESS, function(teste) {
    console.log('login\nOK --> [', teste.username, ']');
    return testemain();
  });
  return api.on(SLSAPI.User.EVENT_LOGIN_FAIL, function(reason) {
    return console.log('login Fail', reason.response.body, reason.response.statusCode);
  });
};
...
testelogin = function() {
  ...
  nbId = null;
  SLSAPI.debug = true;
  api.on(SLSAPI.Config.EVENT_READY, function(id) {
    var notebook_name;
    notebook_name = 'lprm_teste ';
    return api.notebook.getByName(notebook_name, function(data) {
      if (data.length > 0) {
        nbId = data[0].id;
        console.log('buscando notebookID \nOK --> [', nbId, ']');
        return testelogin2();
      } else {
        return console.error("ERROR --> notebook '" + notebook_name + "' not found!");
      }
    }, function(error) {
      console.error('ERRORR -->', error);
      return console.log('não existe repositório com este nome');
    });
  });
  return api;
};
